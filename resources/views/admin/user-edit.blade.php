...
<form method="post" class="max-w-sm mx-auto" action=".">
  ...
  <div class="md:flex md:items-center mb-6">
    ...
    <div class="md:w-2/3">
      <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-quota" type="text" pattern="^-?\d*\.?\d+$" name="quota" placeholder="{{ $user->quota > 0 ? $user->quota/1048576 : $user->quota }}" title="请输入数值">
    </div>
  </div>
