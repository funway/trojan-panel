...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50">
        <div class="flex flex-col h-screen bg-gradient-to-r from-gray-800 via-gray-300 to-gray-100">
            ...
            <div class="relative h-full flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white pb-32">
                <main class="">
                    ...
                    <blockquote class="border-l-4 border-gray-500 italic text-gray-700 bg-gray-200 p-4">
